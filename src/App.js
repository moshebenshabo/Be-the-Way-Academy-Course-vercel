  ...
  const products = [
    {
      ...
      features: ['קורס דיגיטלי (10 פרקים)', '8 מפגשי זום קבוצתיים', 'מאמן אישי (זמינות יומית + 2 מפגשים)', 'קבוצת וואטסאפ לדיווח תוצאות'],
      extendedDetails: [
        { icon: <Video className="w-5 h-5 text-amber-500" />, title: 'קורס דיגיטלי', desc: '10 מפגשים מוקלטים המהווים את פרקי התוכן המרכזיים של התוכנית.' },
        { icon: <MonitorPlay className="w-5 h-5 text-amber-500" />, title: 'מפגשי זום קבוצתיים', desc: '8 מפגשי זום: מפגש פתיחה, מפגש בעקבות כל פרק מהקורס הדיגיטלי, ומפגש סיום.' },
        { icon: <MapPin className="w-5 h-5 text-amber-500" />, title: 'מאמן/ת אישי/ת', desc: 'מענה יומי בוואטסאפ אישי ו-2 אימונים פיזיים (במרכז, בבית או בפארק הקרוב אליכם).' },
        { icon: <MessageCircle className="w-5 h-5 text-amber-500" />, title: 'קבוצת וואטסאפ', desc: 'קבוצה פעילה לכלל המשתתפים המיועדת לדיווח על תוצאות והצלחות (ללא שאלות אישיות).' }
      ],
      internalDetails: [
